    ...
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 navbar" aria-label="Global">
        <div class="flex lg:flex-1">
            <a href="#" class="-m-1.5 p-1.5">
                ...
                <img class="h-3 w-auto " src="{{ asset('imgs/black.png') }}" alt="">
            </a>
        </div>
        ...
        <div class="hidden lg:flex lg:gap-x-12">
            <a href="#" class="text-sm font-semibold leading-6 text-black">ABOUT US</a>
            <a href="#" class="text-sm font-semibold leading-6 text-black">SERVICES</a>
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            <a href="#" class="text-sm font-semibold leading-6 text-black">Log in <span aria-hidden="true">&rarr;</span></a>
        </div>
    </nav>
