...
<body>
    ...
    <div class="slider-container">
        <div class="single-item">
            <div><img src="{{ asset('imgs/banner.png') }}" alt="Image 1"></div>
            <div><img src="{{ asset('imgs/banner.png') }}" alt="Image 2"></div>
            <div><img src="{{ asset('imgs/banner.png') }}" alt="Image 2"></div>
            <div><img src="{{ asset('imgs/banner.png') }}" alt="Image 2"></div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('.single-item').slick({
                dots: true,
                prevArrow: '<button style="color:white;" class="slick-prev" aria-label="Previous"><i class="fas fa-chevron-left"></i></button>',
                nextArrow: '<button style="color:white;" class="slick-next" aria-label="Next"><i class="fas fa-chevron-right"></i></button>'
            });
        });
    </script>
</body>
